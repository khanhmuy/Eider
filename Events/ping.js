	...
	execute(client, message) {
		...
		if (message.content.startsWith(`<@!${client.user.id}>`) || message.content.startsWith(`<@${client.user.id}>`)) {
			const embed = new MessageEmbed()
				...
				.setDescription('I\'m a Discord Bot made by CallMeEcho#0253 and modified by hmuy#4638, built with [Node.js](https://nodejs.org) and [Discord.js](https://discord.js.org).\n')
